<svg display="none" width="0" height="0" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
	<symbol id="caret" viewBox="0 0 7 12">
		<polyline fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" points="1.211,1 6.07,5.86 0.93,11 "/>
	</symbol>
	<symbol id="closeIcon" viewBox="0 0 25.102 25.145">
		<path fill="none" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" d="M24.573 24.614L.53.572M.53 24.572L24.573.53"/>
	</symbol>
	<symbol id="defaultUserIcon" viewBox="0 0 31.5 31.5">
		<path fill="none" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" d="M7.65 28.183c.47-2.558 2.126-4.7 4.377-5.84l-.09-.627c-2.383-1.33-3.993-3.877-3.993-6.798 0-4.297 3.483-7.78 7.78-7.78 4.294 0 7.776 3.483 7.776 7.78 0 2.888-1.573 5.408-3.91 6.75l-.157.677c2.317 1.17 4.008 3.41 4.416 6.074"/>
		<circle fill="none" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" cx="15.75" cy="15.75" r="15"/>
		<path fill="none" d="M0 0h31.5v31.5H0z"/>
	</symbol>
	<symbol id="externalLinkIcon" viewBox="0 0 10 10">
		<path stroke="currentColor" stroke-width="1.5" fill="none" d="M8.5 1.5l-8 8M8.996 6.997V1H3"/>
	</symbol>
	...
	<symbol id="liferayLogo-logoBorder">
		<g class="liferayLogo-logoBorder">
	...
	<symbol id="liferayLogo-gradientLightest">
		<g class="liferayLogo-gradientLightest">
	...
	<symbol id="liferayLogo-gradientLight">
		<g class="liferayLogo-gradientLight">
	...
	<symbol id="liferayLogo-gradientDark">
		<g class="liferayLogo-gradientDark">
	...
	<symbol id="liferayLogo-gradientDarkest">
		<g class="liferayLogo-gradientDarkest">
	...
	<symbol id="moreIcon" viewBox="-73.5 20.5 5.13 44">
		<circle fill="currentColor" cx="-70.935" cy="31.063" r="2"/>
		<circle fill="currentColor" cx="-70.935" cy="52.25" r="2"/>
		<circle fill="currentColor" cx="-70.935" cy="41.563" r="2"/>
	</symbol>
	<symbol id="searchIcon" viewBox="0 0 36 36">
		<circle fill="transparent" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" cx="15" cy="15" r="8"/>
		<path fill="transparent" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" d="M23.3 23.3L29 29"/>
	</symbol>
	<symbol id="toggleCircle" viewBox="8 8 20 20">
		<ellipse fill="none" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" cx="18" cy="18" rx="8" ry="8"/>
		<path fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-miterlimit="10" d="M14 18h8M18 22v-8"/>
	</symbol>
