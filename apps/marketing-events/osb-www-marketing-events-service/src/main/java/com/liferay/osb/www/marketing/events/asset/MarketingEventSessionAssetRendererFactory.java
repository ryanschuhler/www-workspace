...
public class MarketingEventSessionAssetRendererFactory
	extends BaseAssetRendererFactory<MarketingEventSession> {

	public static final String CLASS_NAME =
		MarketingEventSession.class.getName();

	public static final String TYPE = "marketing_event_session";

	public MarketingEventSessionAssetRendererFactory() {
	...
	@Override
	public AssetRenderer<MarketingEventSession> getAssetRenderer(
			long classPK, int type)
		throws PortalException {

		MarketingEventSession marketingEventSession =
			MarketingEventSessionLocalServiceUtil.getMarketingEventSession(
				classPK);

		return new MarketingEventSessionAssetRenderer(marketingEventSession);
	}
