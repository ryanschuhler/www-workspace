...
import com.liferay.osb.www.marketing.events.service.base.SocialLinkServiceBaseImpl;
 ...
 * @author Joan H. Kim
 */
public class SocialLinkServiceImpl extends SocialLinkServiceBaseImpl {
	...
	public List<SocialLink> getSocialLinks(
		...
		return socialLinkLocalService.getSocialLinks(
			marketingEventUserId, start, end, null);
	}
