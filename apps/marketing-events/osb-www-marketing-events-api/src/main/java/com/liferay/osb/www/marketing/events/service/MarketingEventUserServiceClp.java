 ...
 */
@ProviderType
public class MarketingEventUserServiceClp implements MarketingEventUserService {
	public MarketingEventUserServiceClp(InvokableService invokableService) {
		...
		_methodName2 = "getMarketingEventUsers";
