 ...
 */
@ProviderType
public class MarketingEventSponsorServiceClp
	implements MarketingEventSponsorService {
	public MarketingEventSponsorServiceClp(InvokableService invokableService) {
		...
		_methodName2 = "getMarketingEventSponsors";

		_methodParameterTypes2 = new String[] { "long", "int", "int" };

		_methodName3 = "getMarketingEventSponsors";
