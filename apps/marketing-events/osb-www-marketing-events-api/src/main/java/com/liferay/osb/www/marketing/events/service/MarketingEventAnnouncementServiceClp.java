 ...
 */
@ProviderType
public class MarketingEventAnnouncementServiceClp
	implements MarketingEventAnnouncementService {
	public MarketingEventAnnouncementServiceClp(
		...
		_methodName2 = "getMarketingEventAnnouncements";

		_methodParameterTypes2 = new String[] { "long", "boolean", "int", "int" };

		_methodName3 = "getMarketingEventAnnouncements";
	...
	public java.util.List<com.liferay.osb.www.marketing.events.model.MarketingEventAnnouncement> getMarketingEventAnnouncements(
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName2,
					...
					new Object[] { marketingEventId, asc, start, end });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
