...
/**
 * Provides the local service interface for SocialLinkType. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SocialLinkTypeLocalServiceUtil
...
public interface SocialLinkTypeLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SocialLinkTypeLocalServiceUtil} to access the social link type local service. Add custom service methods to {@link com.liferay.osb.www.marketing.events.service.impl.SocialLinkTypeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public SocialLinkType addSocialLinkType(long userId, java.lang.String name,
		long imageFileEntryId) throws PortalException;
	...
	*/
	...
	public SocialLinkType addSocialLinkType(SocialLinkType socialLinkType);
	...
	*/
	public SocialLinkType createSocialLinkType(long socialLinkTypeId);
	...
	*/
	...
	public SocialLinkType fetchSocialLinkType(long socialLinkTypeId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SocialLinkType getSocialLinkType(long socialLinkTypeId)
		throws PortalException;
	...
	*/
	...
	public SocialLinkType updateSocialLinkType(long socialLinkTypeId,
		java.lang.String name, long imageFileEntryId) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public SocialLinkType updateSocialLinkType(SocialLinkType socialLinkType);
}