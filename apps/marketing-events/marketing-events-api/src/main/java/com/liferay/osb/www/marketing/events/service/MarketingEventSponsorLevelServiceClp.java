 ...
 */
@ProviderType
public class MarketingEventSponsorLevelServiceClp
	implements MarketingEventSponsorLevelService {
	public MarketingEventSponsorLevelServiceClp(
		...
		_methodName2 = "getMarketingEventSponsorLevels";

		_methodParameterTypes2 = new String[] { "long", "int", "int" };
	}
