...
/**
 * Provides the local service interface for SocialLink. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SocialLinkLocalServiceUtil
...
public interface SocialLinkLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SocialLinkLocalServiceUtil} to access the social link local service. Add custom service methods to {@link com.liferay.osb.www.marketing.events.service.impl.SocialLinkLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public SocialLink addSocialLink(long userId, long marketingEventUserId,
		long socialLinkTypeId, java.lang.String url) throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SocialLink> getSocialLinks(long marketingEventUserId,
	...
	*/
	...
	public SocialLink updateSocialLink(long socialLinkId,
		long socialLinkTypeId, java.lang.String url) throws PortalException;
