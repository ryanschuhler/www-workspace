...
public class PortletPropsValues {
	...
	public static final String DOSSIERA_DATABASE_HOST = "";
//		PortletPropsKeys.DOSSIERA_DATABASE_HOST

	public static final String DOSSIERA_DATABASE_NAME = "";
//		PortletPropsKeys.DOSSIERA_DATABASE_NAME

	public static final String DOSSIERA_DATABASE_PASSWORD = "";
...
//		PortletPropsKeys.HUBSPOT_RENEWAL_COUNTRY_CODES
	...
	public static final String HUBSPOT_RENEWAL_DAYS_INTERVAL = "";
//		PortletPropsKeys.HUBSPOT_RENEWAL_DAYS_INTERVAL;

	public static final String HUBSPOT_RENEWAL_EMAIL = "";
//		PortletPropsKeys.HUBSPOT_RENEWAL_EMAIL

	public static final String[] HUBSPOT_RENEWAL_LANGUAGE_IDS = new String[0];
//		PortletProps.getArray(PortletPropsKeys.HUBSPOT_RENEWAL_LANGUAGE_IDS

	public static final String HUBSPOT_RENEWAL_SUBJECT = "";
//		PortletPropsKeys.HUBSPOT_RENEWAL_SUBJECT

	public static final String HUBSPOT_RENEWAL_TEMPLATE_ID = "";
...
//		PortletProps.get(PortletPropsKeys.HUBSPOT_VID_SYNC_INTERVAL
	...
	public static final int HUBSPOT_VID_SYNC_MAX_RESULTS = 0;
