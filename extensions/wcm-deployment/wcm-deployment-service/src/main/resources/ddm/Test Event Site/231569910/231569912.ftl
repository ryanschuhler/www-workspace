	...
	<#if friendly_url?has_content >
		...
		<div class="standard-padding">
			<#if layout?has_content>
				...
				<#assign portlet_preferences_local_service = serviceLocator.findService("com.liferay.portal.service.PortletPreferencesLocalService") />
